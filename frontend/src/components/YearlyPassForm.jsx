...
export function YearlyPassForm({ onBack }) {
  ...
  const handleSubmit = (e) => {
    ...
    // --- 2. DATE VALIDATION (Max 1 Month / 30 Days) ---
    ...
    if (diffDays > 365) {
      alert(`Pass duration cannot exceed 365 days. Current: ${diffDays} days`);
      return;
    }

    // If all validations pass
    console.log("Form submitted successfully:", formData);
    alert("Diamond Pass Registered Successfully!");
    onBack(); 
  };
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-2">
        ...
        <p className="text-xs font-bold uppercase tracking-widest text-cyan-400">Premium Diamond Registration</p>
      </div>
